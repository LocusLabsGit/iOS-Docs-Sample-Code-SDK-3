...
class ViewController: UIViewController, LLVenueDatabaseDelegate, LLMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Obtain a key and secret from your LL account manager or help@locuslabs.com
        LLConfiguration.shared()?.setValue("???", forKey: "iaApiKey")
        LLConfiguration.shared()?.setValue("???", forKey: "iaSecret")
            
        // Activate logging to see if your installation is successful
        LLLogger.default()?.logLevel = .debug
