...
//  AtriusSamplesSwift
//
//  Created by Juan Kruger on 17/03/2023.
//
...
class ViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        "Directions UI", "External Location Services", "GRAB Integration" , "Headless Mode", "Map Basics", "Markers", "POI Buttons", "POI Show",
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        else if sample == "Headless Mode" {vcToShow = HeadlessMode() as UIViewController}
