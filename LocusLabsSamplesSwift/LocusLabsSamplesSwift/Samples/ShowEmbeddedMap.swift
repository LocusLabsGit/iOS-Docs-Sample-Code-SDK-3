...
class ShowEmbeddedMap: UIViewController, LLVenueDatabaseDelegate, LLMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        mapView = LLMapView(frame: CGRect(x: 0.0, y: 100.0, width: view.bounds.size.width, height: 220))
        ...
        venueDatabase.loadVenueAndMap("lax") { (_venue: LLVenue?, _map: LLMap?, _floor: LLFloor?, _marker: LLMarker?) in
            ...
            self.venue = _venue
            self.mapView?.positioningEnabled = false
        }
    }
